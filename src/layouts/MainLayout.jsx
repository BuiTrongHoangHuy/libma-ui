                ...
                <div className="relative flex ml-auto w-[260px] h-[55px] rounded-md mt-8 mr-8">
                    <DropdownMenu.Root>
                        <DropdownMenu.Trigger asChild>
                            <div className="flex items-center gap-4 group pl-4 py-4 cursor-pointer bg-gray-400 rounded-2xl transition-transform duration-200 ease-in-out hover:scale-105">
                                <div className="flex flex-col">
                                    <span className="font-bold text-black">Huy Bui Trong Hoang</span>
                                    <span className="text-sm text-black">Account menu</span>
                                </div>
                                <div className="flex items-center justify-center w-12 h-12 bg-primary-color text-white rounded-full transition-transform duration-200 ease-in-out group-hover:scale-110">
